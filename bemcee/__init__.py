...
__version__ = "1.0"
__all__ = ('beta', 'bin_data', 'find_nearest', 'find_neighbours', 'geneva_interp_fast', 'griddataBA', 'griddataBA_new', 'griddataBAtlas', 
    'jy2cgs', 'kde_scipy', 'lineProf', 'linfit', 'quantile', 'readBAsed', 'readXDRsed', 'readpck', 'Ha_delta_v', 'delta_v', 'fwhm2sigma',
    'gauss', 'W2oblat', 'hfrac2tms', 'obl2W', 'oblat2w', 't_tms_from_Xc', 'Sliding_Outlier_Removal', 'check_list', 'combine_sed', 
    'create_list', 'create_tag', 'find_lim', 'find_nearest2', 'read_BAphot2_xdr', 'read_aara_xdr', 'read_acol_Ha_xdr',
