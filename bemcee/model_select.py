...
def read_BAphot2_xdr():
    ...
    xdrPL = folder_models + "BeAtlas2021_phot_Puxadinho.xdr"
...
np.savetxt(
    "M{:.2f}_Ob{:.2f}_omega{:.2f}_Rp{:.2f}_Beta{:.2f}_incl{:.2f}_logL{:.2f}.txt".format(
        Mass, oblat, omega, Rpole, Beta, incl, logL
    ),
    np.c_[lbdarr, mod],
)
