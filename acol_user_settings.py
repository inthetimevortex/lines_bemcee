...
Nsigma_dis = 2.0  # Set the range of values for the distance
...
corner_color = "green"  # OPTIONS ARE: blue, dark blue, teal, green, yellow, orange, red, purple, violet, pink.
# IF YOU DO NOT CHOOSE A COLOR, A RANDOM ONE WILL BE SELECTED

# Plot options
compare_results = (
    False  # Plot the reference Achernar values in the corner (only for model aeri)
)
